...
public class MainMenu implements Menu {
	...
	public void start() {
		...
		mainLoop: while(true){
			...
			if(userElection.equalsIgnoreCase(Main.EXIT_COMMAND)){
				System.exit(0);
			} else{
				int userOptionElection = Integer.parseInt(userElection);
				switch(userOptionElection){
					case 1:
					...
					case 6:
						...
						break mainLoop;
					default:
						System.out.println("You enter a option not avaible, try again.");
						continue;
				}
			}
		}
	...
	public void printMenuHeader() {
		...
		if(context.getLoggedInUser()!=null) System.out.println(MAIN_MENU_TEXT_FOR_LOGGED_IN_USER);
		else{System.out.println(MAIN_MENU_TEXT_FOR_LOGGED_OUT_USER);}
	}
